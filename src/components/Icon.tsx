...
export function Icon({ name, className = "" }: { name: string; className?: string }) {
  const paths: Record<string, string> = {
    ...
    zoomIn: "M11 18a7 7 0 1 1 0-14 7 7 0 0 1 0 14z M20 20l-4-4 M11 8v6 M8 11h6",
    zoomOut: "M11 18a7 7 0 1 1 0-14 7 7 0 0 1 0 14z M20 20l-4-4 M8 11h6",
    ...
    info: "M12 22a10 10 0 1 1 0-20 10 10 0 0 1 0 20z M12 11v6 M12 7h.01",
